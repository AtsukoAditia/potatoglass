          ...
          <template v-slot:body>
            <div class="chat-data-block">
              <b-row>
                ...
                <div class="col-lg-9 chat-data p-0 chat-data-right" :style="`background: #f5fafc !important;`">
                        ...
                        <div class="chat-head">
                          <header class="d-flex justify-content-between align-items-center bg-white pt-3 pr-3 pb-3">
                            <ToggleButton :mini-toggle="true" :close-button="false" toggleShow="#chat-user-detail-popup" mediaClass="chat-user-profile">
                              ...
                              <template v-slot:body>
                                <h5 class="mb-0">Pondok Sneakhead</h5>
...
export default {
  ...
  data () {
    return {
      search: '',
      user: new User({ id: 1, name: 'Vendor Oke', role: 'Vendor', image: require('../../../assets/images/logo.png'), isActive: true }),
      usersList: Users,
      chat: MessagesUser1,
      joinBtn: false,
      channel: 'DemoRoom',
