          ...
          <template v-slot:body>
            ...
            <b-table
              ...
              <template v-slot:cell(platform)="row">
                <b-badge v-if="row.item.platform == 'web'" variant="info">Website</b-badge>
                <b-badge v-else variant="info">App Desktop</b-badge>
              </template>

              <template v-slot:cell(type)="row">
                <b-badge v-if="row.item.type == 'vendor'" variant="warning">Vendor</b-badge>
                <b-badge v-else-if="row.item.type == 'admin'" variant="dark">Admin</b-badge>
                <b-badge v-else variant="info">Contractor</b-badge>
              </template>
...
export default {
  ...
  methods: {
    getDataList (ctx) {
      ...
      // }
      return API.menu
        .getMenu(currPage, ctx.perPage).then(response => {
    ...
    detailGroup (dt) {
      this.$router.push({ name: 'menu.detail', params: { id: dt } })
    },
