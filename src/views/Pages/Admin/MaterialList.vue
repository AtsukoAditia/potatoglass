<template>
  <b-container fluid>
      ...
      <b-col sm="12">
        <iq-card>
          ...
          <template v-slot:headerAction>
            <b-button class="float-right mr-2" variant="info" v-b-modal.modalImportMaterial>Bulk Update Material</b-button>
            <b-button class="float-right" variant="primary" v-b-modal.modalAddMaterial>Add Material</b-button>
          </template>
          <template v-slot:body>
            ...
            >
              ...
              <template #cell(actions)="row">
                ...
                <router-link :to="`master-material/vendor/${row.item.id}`">
                <b-button v-b-tooltip.top="'Lihat Data Vendor'" size="sm" variant="warning" class="mr-1">
                  <div data-icon="" class="icon"></div>
                </b-button>
                </router-link>
              </template>
    ...
    <b-modal id="modalAddMaterial" title="Tambah data material" size="lg" ok-title="Tambah data" cancel-title="Batal" @ok="addNewMaterial">
        <form>
          <b-container>
            <b-row>
              <b-col md="12">
                    <b-form-group
                      ...
                      label="Nama Material"
                    >
                      <b-form-input id="nama_material" v-model="material.nama_material" type="text" placeholder="-"></b-form-input>
                    </b-form-group>
                </b-col>
                <b-col md="6">
                    <b-form-group
                      ...
                      label="Merk"
                    >
                      <multiselect v-model="material.id_merk" id="id_merk" label="category" placeholder="Type to search" open-direction="bottom" :searchable="true" :internal-search="false" :clear-on-select="false" :options="merkSel.map(x => x.id)" :custom-label="opt => merkSel.find(x => x.id == opt).category"></multiselect>
                    </b-form-group>
                </b-col>
                <b-col md="6">
                    <b-form-group
                      ...
                      label="Satuan"
                    >
                      <multiselect v-model="material.id_satuan" id="id_satuan" label="category" placeholder="Type to search" open-direction="bottom" :searchable="true" :internal-search="false" :clear-on-select="false" :options="satuanSel.map(x => x.id)" :custom-label="opt => satuanSel.find(x => x.id == opt).category"></multiselect>
                    </b-form-group>
                </b-col>
                <b-col md="6">
                 <b-form-group
                ...
                <b-col md="4">
                    <b-form-group
                      ...
                      label="Panjang (Cm)"
                    >
                      <b-form-input id="panjang" v-model="material.panjang" type="number" placeholder="-"></b-form-input>
                    </b-form-group>
                </b-col>
                <b-col md="4">
                    <b-form-group
                      ...
                      label="Lebar (Cm)"
                    >
                      <b-form-input id="lebar" v-model="material.lebar" type="number" placeholder="-"></b-form-input>
                    </b-form-group>
                </b-col>
                <b-col md="4">
                    <b-form-group
                      ...
                      label="Tinggi (Cm)"
                    >
                      <b-form-input id="tinggi" v-model="material.tinggi" type="number" placeholder="-"></b-form-input>
                    </b-form-group>
                </b-col>
                <b-col md="4">
                    <b-form-group
                      ...
                      label="Berat (Kg)"
                    >
                      <b-form-input id="berat" v-model="material.berat" type="number" placeholder="-"></b-form-input>
                    </b-form-group>
                </b-col>
            </b-row>
          </b-container>
    ...
    <!-- Import Modal -->
    <b-modal ref="modalMaterialImport" id="modalImportMaterial" title="Update semua material dengan file Excel" size="lg" @ok="submitImport">
      <b-row>
...
export default {
  ...
  methods: {
    ...
    getDataList (ctx) {
      ...
      const promise = axios.get(`${constant.urlAPIPHP}/get_material?limit=${ctx.perPage}&skip=${currPage}&status=1${filterName}`)
    ...
    addNewMaterial () {
      ...
      Object.keys(this.material).forEach(key => {
        dataPost.append(key, this.material[key])
      })
    ...
    getEksportMaterial () {
      ...
      //     }
      //   })
      window.location.href = `${constant.urlAssetsPHP}attachment/excel/MasterMaterial.xlsx`
    },
    submitImport () {
      ...
      API.material
        .importMaterial(fd).then(response => {
          if (response.status === 200) {
