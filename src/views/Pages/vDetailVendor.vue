            ...
            <div class="profile-header">
              <div class="cover-container">
                ...
                <ul class="header-nav d-flex flex-wrap justify-end p-0 m-0">
                  <li><b-link href="/profile-edit"><i class="ri-pencil-line"></i></b-link></li>
                    ...
                    <div class="user-detail pl-5">
                      <div class="d-flex flex-wrap align-items-center">
                        <div class="profile-img pr-4">
                          <b-img v-bind:src="logos" alt="profile-img" fluid class="avatar-130" />
                        </div>
            ...
            <iq-card>
              ...
              <template v-slot:body>
                <b-list-group flush v-for="(list,index) in news" :key="index">
                  <b-list-group-item class="p-1 border-bottom-0" button>{{ list.description }}</b-list-group-item>
                </b-list-group>
              </template>
            </iq-card>
          </b-col>
          <b-col lg="7" class="profile-center">
            <h4 class="card-title mb-2">Semua Produk</h4>
      ...
      API
        .getMaterialProfile(0, 10, idUser).then(response => {
          ...
          if (response.status === 200) {
            ...
            this.user.vendor_name = dt.data[0].name_vendor
          }
        })
    },
    getVerifProfil () {
      API.profile.getVerifBar().then(response => {
        const dt = response.data
        this.valueBar = dt.data.rate
        this.tipData = {
          title: `Proses Verifikasi Data: <br> <ul><li><span class="font-weight-bold">${this.checkFile(dt.data.sub.email)} Verifikasi Email</span></li><li><span class="font-weight-bold">${this.checkFile(dt.data.sub.ktp)} Upload KTP</span></li><li><span class="font-weight-bold">${this.checkFile(dt.data.sub.npwp)} Nomor NPWP</span></li><li><span class="font-weight-bold">${this.checkFile(dt.data.sub.toko)} Video Toko</span></li><li><span>${this.checkFile(dt.data.sub.video_ktp)} Video Toko</span></li></ul>`,
          variant: 'info'
        }
