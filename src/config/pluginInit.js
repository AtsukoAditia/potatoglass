...
export const APPNAME = 'Proyekita'

export const brokenImage = require('../assets/images/proyekita.png')
export const urlAssets = constant.urlAssetsPHP
    ...
    if (type !== null) {
      switch (type) {
        ...
        case 'error':
          ...
          break
        case 'warning':
          Snackbar.show({ text: data, backgroundColor: '#766200', textColor: '#FFFFFF', actionTextColor: '#FFFFFF' })
          break
      }
    } else {
      Snackbar.show(data)
